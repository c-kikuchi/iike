...
function IIWidgetsBuilder(bridge){
  return [
    ...
    LabeledCommentWidgetBuilder("見出し語"),
    LabeledCommentWidgetBuilder("読み"),
    LabeledCommentWidgetBuilder("原文表記"),
    LabeledCommentWidgetBuilder("肩書き"),
    LabeledCommentWidgetBuilder("メモ"),
